...
import com.bd.shuyu.motiontrackingandroid.VideoTracking_Handler_Activity;

//UIThread
public class BitmapManager{

    static final int TASK_COMPLETE = VideoTracking_Handler_Activity.DECODE_STATE_COMPLETED;
