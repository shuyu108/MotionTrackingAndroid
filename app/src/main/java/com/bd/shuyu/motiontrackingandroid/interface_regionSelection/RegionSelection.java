...
public class RegionSelection extends View {
        ...
        public RegionSelection(final Context context) {
                super(context);
                init();
        }

        public RegionSelection(final Context context, final AttributeSet attrs) {
                super(context, attrs);
                init();
        }

        public RegionSelection(final Context context, final AttributeSet attrs, final int defStyle) {
